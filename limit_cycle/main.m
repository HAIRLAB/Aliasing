...
Nsim = 401; % collect point for each traj
...
%% %% ****************************  Print error  *******************************
    ...
    w_true = zeros(N,n);    Nw_nonzero = 8;
    w_true(1,1) = 1; w_true(2,1) = mu; w_true(6,1) = -1; w_true(8,1) = -1; 
    w_true(1,2) = -mu; w_true(2,2) = 1; w_true(7,2) = -1; w_true(9,2) = -1; 
